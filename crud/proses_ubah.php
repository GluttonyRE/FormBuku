...
if(empty($gambar)){ // Jika user tidak memilih file foto pada form
	...
	$sql = $pdo->prepare("UPDATE formbuku SET judul=:judul, pengarang=:pengarang, penerbit=:penerbit, WHERE id_buku=:id_buku");
	...
	if(move_uploaded_file($tmp, $path)){ // Cek apakah gambar berhasil diupload atau tidak
		...
		// Proses ubah data ke Database
		$sql = $pdo->prepare("UPDATE formbuku SET judul=:judul, pengarang=:pengarang, penerbit=:penerbit, gambar=:gambar WHERE id_buku=:id_buku");
		$sql->bindParam(':judul', $judul);
		$sql->bindParam(':pengarang', $pengarang);
		$sql->bindParam(':penerbit', $penerbit);
